...
const AddStatus = () => {
  ...
  const { status: fetchedStatus, loading, updateStatus, addStatus } = useStatuses(); // Custom hook to manage statuses
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addStatus(statusData); // Call the addStatus function
